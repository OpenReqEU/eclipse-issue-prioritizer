...
class PrioritizedRecommendationsRequest(Model):
    """NOTE: This class is auto generated by the swagger code generator program.

    Do not edit the class manually.
    """

    def __init__(self, agent_id: str=None, assignee: str=None, components: List[str]=None,
                 products: List[str]=None, keywords: List[str]=None):  # noqa: E501
        """PrioritizedRecommendationsRequest - a model defined in Swagger
